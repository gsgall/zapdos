...
// top right round
Point(46) = {(fin_width - round_radius), inner_channel_length + y_buffer, 0 };
Point(47) = {(fin_width - round_radius), inner_channel_length + y_buffer - round_radius, 0 };
Point(48) = {(fin_width), inner_channel_length + y_buffer  - round_radius, 0 };
// bottom right
...
Physical Line("atmosphere") = {4849,495051};
...
// defining the domain
Line Loop(200) = {355,555657,5758,585960,6061,616263,6352, 525354, 5446, 464748, 4849, 495051, 518, 87,70,01,13};
